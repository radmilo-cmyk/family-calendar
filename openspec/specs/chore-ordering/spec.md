# chore-ordering Specification

## Purpose
Defines how default chores can be reordered via the settings page, and how the mobile header layout is preserved across all screen sizes.
